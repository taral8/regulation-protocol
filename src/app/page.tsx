          ...
          <div className="max-w-3xl">
            ...
            <FadeIn delay={0.1}>
              <p className="mt-6 text-lg sm:text-xl text-primary-600 leading-relaxed max-w-2xl">
                For high-functioning, spiritually aware adults who look strong on
                the outside but feel overwhelmed inside.
              </p>
            </FadeIn>
            <FadeIn delay={0.2}>
            ...
            <FadeIn delay={0.3}>
              <p className="mt-6 text-sm text-muted">
                No hype. No shortcuts. Just regulated, embodied transformation.
              </p>
            </FadeIn>
          </div>
        </Container>
